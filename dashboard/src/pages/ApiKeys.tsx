    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-xs uppercase tracking-[0.12em] text-[--on-surface-variant] mt-1 sm:mt-1.5 font-medium">
          {isAdmin
            ? "Manage secure access tokens for all users."
            : "Your assigned API access tokens."}
        </p>
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-[--on-surface-variant] mt-1 leading-relaxed">
              Never share your secret keys in client-side code or public repositories. Rotate keys
              every 90 days for maximum security.
            </p>
          </div>
        </div>
      </div>
